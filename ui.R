                      ...
                      dashboardBody(
                        ...
                        conditionalPanel(
                          ...
                          box(title="Thresholds",width=3,solidHeader = T,status="primary",
                              ...
                              sliderInput("fcval","log-ratio threshold",value=c(-1,1),min=-1,max=1,step=0.1,width = "200px"),
                              bsTooltip("fcval","Filter table for log-ratio (log of fold change) threshold",trigger="hover"),
                              actionButton("allLimsSelection",HTML("Select all features filtered by<br/> q-value and fold-change"))),
