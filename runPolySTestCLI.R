...
if (length(args)==0) {
  stop("You need to specify the parameter file, see polystest.yml in the main folder as example and descriptions of the parameter values. 
       This function needs to be carried out in the folder where the PolySTest files are located", call.=FALSE)
}  
parfile <- args[1]
