...
# Volcano plot
plotVolcano(fulldata_unpaired, compNames = comps, sel_prots = sigProts, testNames = c("PolySTest", "limma", "Miss Test"))
```

Now let's look into the overlap between the different statistical tests. An upset plot
...
functions. We recommend using the Bioconductor package [VSClust](https://bioconductor.org/packages/release/bioc/html/vsclust.html) 
or its [Shiny web application](https://computproteomics.bmb.sdu.dk/app_direct/VSClust/) from your lab.  
...
our web applications [ComplexBrowser](https://computproteomics.bmb.sdu.dk/app_direct/ComplexBrowser) and [CoExpresso](https://computproteomics.bmb.sdu.dk/app_direct/CoExpresso).
